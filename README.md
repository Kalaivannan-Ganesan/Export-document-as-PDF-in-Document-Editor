...
\- Export \`.docx\` or \`.sfdt\` documents to PDF  \
 \- Preserve formatting, images, tables, styles and more Word document elements  \
 \- Works across modern browsers and platforms  \
 \- No dependency on Microsoft Office  \
 \- Supports server\-side conversion for scalability  
